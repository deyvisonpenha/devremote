      ...
      <div className="flex justify-center">
        <Card className="w-[1200px] h-[500px] bg-black rounded-3xl  ">
          <CardHeader className="ml-44 ">
            <h1 className="text-white font-normal text-4xl  mb-5 mt-28">
              Tell us about your project
            </h1>
            <Button className="  w-28 py-5 bg-slate-50 text-black rounded-3xl font-bold ">
              Say Hei
            </Button>
            <h1 className=" flex justify-around text-zinc-800 mr-96 mt-36 ">
              ____________________________________________________________________________
            </h1>

            <div className="mt-16 grid  grid-cols-2">
              <div>
                <h1 className="text-white font-normal text-xl  mt-9 mb-7 ">
                  Our offices
                </h1>
